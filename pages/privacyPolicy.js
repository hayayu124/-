      ...
      <section className={`${cn.privacyPolicy} sectionSpaceM mar-b4 sec-c`}>
        ...
        <div className={`${cn.privText} grid4`}>
          <p className={`fon4 fonSp4 lin-9`}>
            ...
            <br />
            <br />
            <span className={`fon3 fonSp3 bold`}>1.事業者情報</span>
            <br />
            法人名:ROSETIQUE JAPAN Inc. <br />
            住所:東京都世田谷区等々力8-12-3 1F <br />
            代表者:堺美和子
            <br />
            <br />
            <br />
            <span className={`fon3 fonSp3 bold`}>2.個人情報の取得方法</span>
            <br />
            ...
            <br />
            <br />
            <span className={`fon3 fonSp3 bold`}>5.個人データの共同利用</span>
            <br />
            当社は,以下のとおり共同利用を行います。
            <br />
            ...
            <br />
            （各社請求方法を指定） 送付先住所 東京都世田谷区等々力8-12-3 1F
            <br />
            <br />
            <br />
            <span className={`fon3 fonSp3 bold`}>
            ...
            <br />
            <br />
            <span className={`fon3 fonSp3 bold`}>10.cookieについて</span>
            <br />
            ...
            <br />
            <br />
            <span className={`fon3 fonSp3 bold`}>12.免責事項</span>
            <br />
            ...
            <br />
            <br />
            <span className={`fon3 fonSp3 bold`}>13.著作権・肖像権</span>
            <br />
            当社Webサイト内の文章や画像,すべてのコンテンツは著作権・肖像権等により保護されています。無断での使用や転用は禁止されています。
            <br />
            <br />
            <br />
            <span className={`fon3 fonSp3 bold`}>14.リンク</span>
            <br />
