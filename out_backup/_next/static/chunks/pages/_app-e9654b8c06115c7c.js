  ...
  [888],
  {
    ...
    8418: function (e, t, n) {
      ...
      var x = c.default.forwardRef(function (e, t) {
        ...
        S && (r = c.default.Children.only(n));
        var U = S ? r && "object" == typeof r && r.ref : t,
        ...
        var H = {
          ...
          onMouseEnter: function (e) {
            S || "function" != typeof M || M(e),
              ...
              !(!E && B) && i.isLocalURL(P) && p(T, P, R, { priority: !0 });
          },
        ...
        if (!S || g || ("a" === r.type && !("href" in r.props))) {
          var Q = void 0 !== w ? w : T && T.locale,
            W =
              T &&
              T.isLocaleDomain &&
              f.getDomainLocale(R, Q, T.locales, T.domainLocales);
          H.href = W || h.addBasePath(s.addLocale(R, Q, T && T.defaultLocale));
        }
        return S
          ? c.default.cloneElement(r, H)
          : c.default.createElement("a", Object.assign({}, O, H), n);
      });
      (t.default = x),
        ("function" == typeof t.default ||
          ("object" == typeof t.default && null !== t.default)) &&
                ...
                children: [
                  (0, r.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, r.jsx)("h5", { children: "Cut Rose Collection" }),
                    ],
                  }),
                  (0, r.jsxs)("div", {
